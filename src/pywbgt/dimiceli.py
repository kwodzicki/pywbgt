...
def psychrometric_wetbulb(temp_air, temp_dew):
    ...
    Inputs:
        temp_air (pint.Quantity) : Ambient (dry bulb) temperature
        temp_dew (pint.Quantity) : Dew point temperature
...
def wetbulb_globe(
    ...
    **kwargs,
    ...
    Notes:
        Enacts 'Recent Updates and Improvements' from the following white
        paper:
