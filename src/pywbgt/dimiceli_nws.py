"""
WBGT from the modified Dimiceli method
...
def conv_heat_flow_coeff(cosz, **kwargs):
    ...
    During daytime (e.g., cosz > 0), return 0.228 and return
    0.0 for night (e.g., cosz <= 0)

    Arguments:
        cosz (float, ndarray) : Cosine of solar zenith angle

    Keyword arguments:
        **kwargs : Any, all ignored
