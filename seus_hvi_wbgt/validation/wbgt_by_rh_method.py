...
from metpy.calc import relative_humidity_from_dewpoint as calcRH
...
def main( *args, methods = None, nCol = 7, **kwargs):
  ...
  fig.savefig( '/Users/kwodzicki/Documents/NCICS/NOAA_Dello_113020_SE-HVI-WBGT/Figures/WBGT_by_rh_method.png',
    dpi = 300 ) 
