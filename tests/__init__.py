...
#
#  xx = wbgt_by_wind_method.main(    data, meta, **kwargs )
#  xx = wbgt_by_station_method.main( data, meta, **kwargs )
#  xx = wbgt_by_solar_method.main(   data, meta, **kwargs )
#  xx = wbgt_by_rh_method.main(      data, meta, **kwargs )
#  
